...
async function handleOperationError(error: unknown) { if (error instanceof ApiError && error.response) { feedback.handleError(error); return }; await load(); ElMessage.warning('操作结果未确认，已刷新状态；请勿重复提交') }
