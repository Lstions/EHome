...
- **数据事件总线**: DataEventBus 6 消费者架构，被动数据快速通道，persistent worker + 64 mailbox — [设计/数据事件总线设计.md](设计/数据事件总线设计.md)
- **ESP32 日志流**: Log V2 远程查看，s_seq 生命周期屏障，QoS 0 + 反馈环抑制 — [设计/ESP32日志流设计.md](设计/ESP32日志流设计.md)
